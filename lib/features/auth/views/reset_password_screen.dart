...
class _ResetPasswordScreenState extends State<ResetPasswordScreen> {
  final _passwordAddressTextController = TextEditingController();
  late bool _isObscure = true;

  @override
  void dispose() {
    _passwordAddressTextController.dispose();
    super.dispose();
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: size.height * 0.02),
            TextFieldCustom(
              controller: _passwordAddressTextController,
              hintText: l10n.resetPassword,
